...
#set output 'C:\Users\smallcat\Dropbox\eclipse\common_workspace\HPCSim\5d-torus-speedup\5d-torus-speedup.png'  

set term post eps color "GothicBBB-Medium-RKSJ-H, 20"      
set output 'C:\Users\smallcat\Dropbox\eclipse\common_workspace\HPCSim\5d-torus-speedup\5d-torus-speedup.eps'  
...
plot  'C:\Users\smallcat\Dropbox\eclipse\common_workspace\HPCSim\5d-torus-speedup\overall-uti.txt' using 2:xtic(1) title "without speedup"with linespoints pointtype 4 linewidth 2 pointsize 2, '' using 3 title "with speedup"with linespoints linewidth 2 pointsize 2 
