...
def output_queue_time():
    ...
    fn = "stat_queue_" + dt + "_" + GUI.topo + "_" + str(tn) + "_" + GUI.schedule + "_" + GUI.mode + "_" + str(GUI.fso_r) + "_fsoconfigtime_" + str(fso_config_time) + "_" + ar #file name
...
#     f = open("stat_su", "w") #system utilization
    ...
    dt = dt.replace(":", "-")
    ar = PWA.archive.replace(".", "-")
    fn = "stat_su_" + dt + "_" + GUI.topo + "_" + str(tn) + "_" + GUI.schedule + "_" + GUI.mode + "_" + str(GUI.fso_r) + "_fsoconfigtime_" + str(fso_config_time) + "_" + ar #file name
    f = open(fn, "w")    #system utilization 
