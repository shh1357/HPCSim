...
tn = 1 #total nodes
fso_config_time = 5 #huyao 151016 
...
def fso():
    count = 0
    ava_nodes = []
    global fso_not_found, jobs_dispatch, first_num, jobs_cpus, jobs_runtime
...
#                                     print "3"
                                    jump_3 = jump_3+1
                                    if(fill==1 and RG.node[nouse[0]]["ava"] == "yes" and RG.node[nouse[0]]["fso"] >= each[1]):
                            ...
                            for bbb in range(b, b+g[1]):
                                for ccc in range(c, c+g[2]):
                                    for ddd in range(d, d+g[3]):
                                        ...
                                        if(fill==1 and aaa==a+g[0]-1 and bbb==b+g[1]-1 and ccc==c+g[2]-1 and ddd==d+g[3]-1 and len(nouse)==0):
                                            nouse.append((aaaa,bbbb,cccc,dddd))
                                    if(over == True):
                                        break                                              
                                if(over == True):
                                    ...
                                    for ccc in range(c, c+g[2]):
                                        for ddd in range(d, d+g[3]):
                                            for eee in range(e, e+g[4]):
                                                ...
                                                dddd = ddd%dd
                                                eeee = eee%ee
                                                if(RG.node[(aaaa,bbbb,cccc,dddd,eeee)]["ava"] == "no" and fill == 0):
                                                    flag = False
                                                    break
                                                if(RG.node[(aaaa,bbbb,cccc,dddd,eeee)]["ava"] == "no" and fill == 1):
                                                    if(flag_ == True):
                                                        flag_ = False
                                    ...
                                    for ccc in range(c, c+g[2]):
                                        for ddd in range(d, d+g[3]):
                                            for eee in range(e, e+g[4]):
                                                ...
                                                if(fill==1 and aaa==a+g[0]-1 and bbb==b+g[1]-1 and ccc==c+g[2]-1 and ddd==d+g[3]-1 and eee==e+g[4]-1 and len(nouse)==0):
                                                    nouse.append((aaaa,bbbb,cccc,dddd,eeee))
                                            if(over == True):
                                                break                                                     
                                        if(over == True):
...
def output_queue_time():
    ...
    fn = "stat_queue_" + dt + "_" + GUI.topo + "_" + str(tn) + "_" + GUI.schedule + "_" + GUI.mode + "_" + str(GUI.fso_r) + "_fsoconfigtime_" + str(fso_config_time) + "_" + GUI.speedup + "_" + ar #file name
    f = open(fn, "w")    #system utilization 
    f.write("#job_number  submit  dispatch  queue  cpu#  runtime  weight  response(turnaround)\n")   
    num = 0
    ...
    for i in range(num_jobs):
        ...
        s = str(i) + "    " + str(jobs_submit[i]) + "    " + str(jobs_dispatch[i]) + "    " + str(queue_time) + "    " + str(jobs_cpus[i]) + "    " + str(jobs_runtime[i]) + "    " + str(job_weight) + "    " + str(response) + "\n"
        f.write(s)
...
#     f = open("stat_su", "w") #system utilization
    ...
    dt = dt.replace(":", "-")
    ar = PWA.archive.replace(".", "-")
    fn = "stat_su_" + dt + "_" + GUI.topo + "_" + str(tn) + "_" + GUI.schedule + "_" + GUI.mode + "_" + str(GUI.fso_r) + "_fsoconfigtime_" + str(fso_config_time) + "_" + GUI.speedup + "_" + ar #file name
    f = open(fn, "w")    #system utilization 
...
#         print ts, "    ", total/tn
        ...
        s = str(ts*timestep) + "    " + str(total) + "    " + str(tn) + "    " + str(uti) + "    " + str(queuing) + "\n"    #150826 huyao ts->ts*timestep
                    ...
                    if(flag == True):
                        ...
                        for aaa in range(a, a+g[0]):
                            for bbb in range(b, b+g[1]): 
                                aaaa = aaa%aa
                                bbbb = bbb%bb
                                if(aaa==a+g[0]-1 and bbb==b+g[1]-1 and fill==1 and all==True and RG.node[(aaaa,bbbb)]["ava"] == "yes"):
#                                     print xxx, yyy
                                    break
                                if(RG.node[(aaaa,bbbb)]["ava"] == "yes"):
                                    RG.node[(aaaa,bbbb)]["ava"] = "no" 
                            ...
                            for aaa in range(a, a+g[0]):
                                for bbb in range(b, b+g[1]): 
                                    for ccc in range(c, c+g[2]):
                                        ...
                                        bbbb = bbb%bb
                                        cccc = ccc%cc
                                        if(aaa==a+g[0]-1 and bbb==b+g[1]-1 and ccc==c+g[2]-1 and fill==1 and all==True and RG.node[(aaaa,bbbb,cccc)]["ava"] == "yes"):
        #                                     print xxx, yyy
                                            break
                                    ...
                                    for bbb in range(b, b+g[1]): 
                                        for ccc in range(c, c+g[2]):
                                            for ddd in range(d, d+g[3]):
                                                ...
                                                cccc = ccc%cc
                                                dddd = ddd%dd
                                                if(aaa==a+g[0]-1 and bbb==b+g[1]-1 and ccc==c+g[2]-1 and ddd==d+g[3]-1 and fill==1 and all==True and RG.node[(aaaa,bbbb,cccc,dddd)]["ava"] == "yes"):
                #                                     print xxx, yyy
                                                    break
                                            ...
                                            for ccc in range(c, c+g[2]):
                                                for ddd in range(d, d+g[3]):
                                                    for eee in range(e, e+g[4]):
                                                        ...
                                                        dddd = ddd%dd
                                                        eeee = eee%ee
                                                        if(aaa==a+g[0]-1 and bbb==b+g[1]-1 and ccc==c+g[2]-1 and ddd==d+g[3]-1 and eee==e+g[4]-1 and fill==1 and all==True and RG.node[(aaaa,bbbb,cccc,dddd,eeee)]["ava"] == "yes"):
                        #                                     print xxx, yyy
                                                            break
