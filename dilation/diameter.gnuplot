...
#set output 'C:\Users\smallcat\Dropbox (å¬êl)\eclipse\common_workspace\HPCSim\dilation\diameter.png'  

set term post eps color "GothicBBB-Medium-RKSJ-H, 20"  
#set term post eps color     
set output 'C:\Users\smallcat\Dropbox (å¬êl)\eclipse\common_workspace\HPCSim\dilation\diameter.eps'  
replot
