set yrange [0.0:9.0]
set key top right font "GothicBBB-Medium-RKSJ-H, 11"
...
#set xtics rotate by -5 font "GothicBBB-Medium-RKSJ-H, 16"
set xtics font "GothicBBB-Medium-RKSJ-H, 16"
set xlabel "Subtopology" font "GothicBBB-Medium-RKSJ-H, 16"
set ylabel "Average Turnaround Time (s)" font ",16"
